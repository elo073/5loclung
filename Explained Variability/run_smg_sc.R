...
cpm=read.table("../Data/smg_sc.csv", header=T, sep=",")
...
###### meta data file
mdata=read.table("../Data/Meta_smg_sc.csv",header=T, sep=",", row.names=1)
...
Barplot(res, "../Plots/SMG_sc_lin.png", "SMG Cells")
...
# fitting lmm
res = LFLMM(cpm_filt, mdata)
Barplot(res, "../Plots/SMG_sc_bin.png", "SMG Cells")
